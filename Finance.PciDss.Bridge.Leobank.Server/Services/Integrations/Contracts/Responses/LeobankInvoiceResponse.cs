...
namespace Finance.PciDss.Bridge.Leobank.Server.Services.Integrations.Contracts.Responses
{
    public class LeobankInvoiceResponse
    {
        ...
        public void Decrypt(string privateKey)
        {
            ...
            var decrypted = crypto.AesDecrypt(Info, key, iv);
            InfoStruct = JsonConvert.DeserializeObject<LeobankInvoiceResponseInfo>(decrypted);
    ...
    public class LeobankInvoiceResponseInfo
    {
    ...
    public class LeobankInvoiceResponseInfoSecure
    {
        [JsonProperty("acsUrl")] public string AcsUrl { get; set; }
        [JsonProperty("method")] public string Method { get; set; }
        [JsonProperty("paReq")] public string PaReq { get; set; }
        [JsonProperty("md")] public string Md { get; set; }
        [JsonProperty("termUrl")] public string TermUrl { get; set; }
    }
}