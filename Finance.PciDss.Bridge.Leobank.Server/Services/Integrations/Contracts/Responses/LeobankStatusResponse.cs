...
namespace Finance.PciDss.Bridge.Leobank.Server.Services.Integrations.Contracts.Responses
{
    public class LeobankStatusResponse
    {
        ...
        public void Decrypt(string privateKey)
        {
            ...
            InfoStruct = JsonConvert.DeserializeObject<LeobankStatusResponseInfo>(crypto.AesDecrypt(Info, key, iv));
    ...
    public class LeobankStatusResponseInfo
    {
